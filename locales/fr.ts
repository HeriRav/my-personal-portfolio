export default {
  ...
  landing: {
    ...
    degree: {
      latest: "Mon dernier diplôme",
      title:
        "Certification RNCP niveau 6, équivalente à une première année de Master",
      description:
        "Obtention d’une certification RNCP niveau 6, reconnue comme équivalente à une première année de Master.",
    },
    works: {
    ...
    biography: {
      ...
      developer: "Développeur logiciel",
      description:
        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Et eius deleniti consequuntur sit incidunt quae ex temporibus expedita id nostrum. Atque, earum! Repellendus possimus quibusdam cupiditate labore, tempore earum sed!",
    },
    about: {
      title: "À propos de moi",
      passion: "Passionné par l’innovation et les nouveaux défis",
      description:
        "Spécialisé dans le développement front-end avec des connaissances en back-end, je conçois des interfaces utilisateur intuitives et performantes. Mon expertise en JavaScript/TypeScript et Java me permet de transformer des idées créatives en applications web réactives.",
      show_more: "... Voir plus",
      motivation:
    ...
    reference: {
      title: "Réference",
      description:
        "Interface utilisateur inspirée du moteur de recherche Google - non affiliée à Google.",
    },
    search_result: {
      resume: {
        title: "Parcours",
  ...
  resume: {
    ...
    academic: {
      card: {
        ...
        title: "Mon dernier diplôme",
        description: "Développement professionnel et certification",
        name: "Inclusiv Academy",
        degree_level: "Certification RNCP niveau 6",
        date: "Septembre 2022 - Avril 2023",
        view_all: "Voir le Parcours Académique Complet",
      },
      title: "Académique",
      description: "Mon Parcours Académique",
      master: {
        year: "Septembre 2022 - Avril 2023",
        title:
          "Certification RNCP niveau 6, équivalente à une première année de Master",
        institution: "Inclusiv Academy",
        description:
          "Obtention de la certification RNCP niveau 6, reconnue comme équivalente à une première année de Master.",
      },
      bachelor: {
        year: "Août 2017 - Juin 2022",
        title: "Espace Universitaire Régional de l'Océan Indien (EUROI)",
        institution:
          "Licence Professionnelle en Électronique / Informatique / Télécommunications",
        description:
          "Obtention d’une licence professionnelle en Électronique, Informatique et Télécommunications après la soutenance réussie de mon mémoire.",
      },
    },
    professional: {
      card: {
        journey: "Parcours Professionnel",
        title: "Ma dernière expérience",
        description:
          "Une Expérience Professionnelle et une Évolution de Carrière",
        name: "Zeno Inno",
        contract: "CDI",
        function: "Développeur logiciel",
        time: "Temps plein",
      ...
      company: [
        ...
        {
          title: "Zeno Inno",
          function: "Stagiaire Développeur Logiciel",
          contract: "Stage",
        ...
        },
        {
          ...
          function: "Développeur d’applications informatiques",
          contract: "CDD",
        ...
        },
        {
          ...
          function: "Stagiaire Développeur WordPress",
          contract: "Stage",
