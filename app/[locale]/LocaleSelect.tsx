        ...
        <div className="absolute right-0 mt-2 w-40 bg-background border rounded-md shadow-md flex flex-col z-50">
          {languages.map(({ code, label, Flag }) => (
            <button
              ...
              className="px-4 py-2 hover:bg-muted hover:dark:bg-black text-left cursor-pointer flex items-center gap-2 disabled:opacity-50 disabled:cursor-default disabled:hover:bg-transparent"
            >
              <Flag />
              <span>{label}</span>
            </button>
