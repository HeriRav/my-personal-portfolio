...
export function AcademicResumeCard() {
  const resumeT = useScopedI18n("resume.academic.card");
          ...
          <div className="space-y-4">
            <div className="flex flex-row items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs md:text-sm xl xl:text-base text-dark-accent/70 dark:text-gray-400 leading-relaxed">
                  {resumeT("degree_level")}
                </p>
              </div>
            </div>
